...
grafana:
  ...
  env:
    ...
    GF_INSTALL_PLUGINS: "camptocamp-prometheus-alertmanager-datasource,grafana-sentry-datasource"
    GF_PLUGINS_ALLOW_LOADING_UNSIGNED_PLUGINS: "camptocamp-prometheus-alertmanager-datasource,grafana-sentry-datasource"
